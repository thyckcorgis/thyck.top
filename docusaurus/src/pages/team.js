...
const Svg = ({ title, pathD }) => (
  <svg
    ...
    alt={title}
  >
    <path className="letter" d={pathD} stroke="white" strokeWidth="3" />
  </svg>
);
...
function Team({ title, altTitle, url, description, altDescription, pathD }) {
      ...
      >
        {isShown ? (
          <div>
            ...
            <Svg key={title} pathD={pathD} title={title} />
